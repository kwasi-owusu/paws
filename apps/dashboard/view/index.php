                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><span>Laurie Fox</span></div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><span>Ryan Collins</span></div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"><span>Irene Collins</span></div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="td-content customer-name"></div><span>Sonia Shaw</span>
                        </div>
                        </td>
                        <td>
                                    ...
                                    <td>
                                        <div class="td-content product-name">
                                            <div class="align-self-center">
                                                ...
                                                <p class="prd-category text-warning">Fashion</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
