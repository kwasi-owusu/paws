...
session_start();
class AddNewSalesOrder
{
    static public function saveNewSalesOrder(){
        $getToken   = $_POST['tkn'];
        $error      = false;
        ...
        if (isset($_SESSION['salesOrderToken']) && $_SESSION['salesOrderToken'] == $getToken){
            ...
            $sales_to_production = strip_tags(trim($_POST['sales_to_production']));
            ...
            require_once('../../model/sales/AddNewSalesOrderMdl.php');
            ...
            if (!$error && $local_tax == 1){
                ...
                $grandTotal         = (float)$nhsAmount + $getFundAmount + $covidTaxAmount + $vatAmount + $taxableAmount;

                if (AddNewSalesOrderMdl::saveNewSalesOrder($customer_ID, $so_terms, $delivery_dt, $quote_number, $curr, $amountDueTop, $itemCode,
                    $itemName, $price, $quantity, $total, $totalAftertax, $amountPaid, $amountDue, $discount_amount, $taxableAmount, $nhsAmount,
                    $getFundAmount, $covidTaxAmount, $totalBeforeVAT, $vatAmount, $grandTotal, $addedBy, $data_owner, $my_branch, $sales_to_production)){
            ...
            elseif (!$error && $local_tax == 0){
                if (AddNewSalesOrderMdl::saveNewSalesOrderNoTax($customer_ID, $so_terms,  $delivery_dt, $quote_number, $curr, $amountDueTop, $itemCode,
...
$callClass      = new AddNewSalesOrder();
$callMethod     = $callClass->saveNewSalesOrder();