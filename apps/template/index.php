...
} elseif (isset($_SESSION["isLogin"]) && $_SESSION["user_type"] == 4) {
    echo '<script>
			window.location = "create_pos";
		</script>';
} else {
...
?>
    ...
    <head>
        ...
        <link href="template/statics/assets/css/components/tabs-accordian/custom-tabs.css" rel="stylesheet" type="text/css" />

        <link rel="stylesheet" type="text/css" href="template/statics/assets/plugins/editors/quill/quill.snow.css">
        <style>
                        ...
                        <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                            <div class="">
                                <div class="dropdown-item">
                                    <a class="" href="../my-profile"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
