...
class EditSupplier
{
    static public function editThisSupplier()
    {
        $tkn = trim($_POST['tkn']);
        $error = false;
        if (isset($_SESSION['editSupplierToken']) && $_SESSION['editSupplierToken'] == $tkn) {
            ...
            elseif (!$error) {
                ...
                if (SuppliersModel::editSupplier($tbl, $data)) {
...
$callMethod     = new EditSupplier();
$thisMethod     = $callMethod->editThisSupplier();