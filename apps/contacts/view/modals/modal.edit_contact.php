...
<h5 class="modal-title" id="myLargeModalLabel">Edit Contact</h5>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="first-name">
                    ...
                    value="<?php echo $cst['firstName']; ?>" required>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="contact-location">
                    ...
                    <textarea class="form-control" maxlength="150" id="contact_notes" name="contact_notes" placeholder="Notes"><?php echo $cst['contact_notes']; ?></textarea>
                </div>
            </div>
        </div>
